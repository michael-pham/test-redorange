...
_PARAMETER_PROCESSING_KEY = "{{_parameter_processing}}"
...
_NORMAL_PARAM_TPL = "angularjs_app/templates/item_service.js/_parameter_processing/_normal_param.js"
ITEM_NAME_IN_CAMEL_CASE_KEY = "{{item_name_in_camel_case}}"
ATTRIBUTE_NAME_KEY = "{{attribute_name}}"
FILTERING_OPERATOR_KEY = "{{filtering_operator}}"

_PLAIN_TD_HTML_TPL = "angularjs_app/templates/items.html/_table_tds/_plain_td.html"
ITEM_NAME_IN_CAMEL_CASE_KEY = "{{item_name_in_camel_case}}"
ATTRIBUTE_NAME_KEY = "{{attribute_name}}"
...
_TEXT_INPUT_HTML_TPL = "angularjs_app/templates/item_create_modal.html/_inputs.html/_text_input.html"
...
_MAX_NGMESSAGE_HTML_TPL = "angularjs_app/templates/item_create_modal.html/_inputs.html/_ngmessages.html/_max_ngmessage.html"
INPUT_LABEL_KEY = "{{input_label}}"
...
_REQUIRED_NGMESSAGE_HTML_TPL = "angularjs_app/templates/item_create_modal.html/_inputs.html/_ngmessages.html/_required_ngmessage.html"
INPUT_LABEL_KEY = "{{input_label}}"
...
_TEXTAREA_INPUT_HTML_TPL = "angularjs_app/templates/item_create_modal.html/_inputs.html/_textarea_input.html"
